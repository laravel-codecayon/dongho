...
class PostController extends BaseController {
	...
	public function getIndex()
	{
		...
		$this->layout->nest('content','post.index',$this->data)
	...
	function getAdd( $id = null)
	{
		...
		if($row)
		{
			...
			$this->data['row'] = $this->model->getColumnTable('post'); 
		}
		...
		$this->data['id'] = $id;
		$this->layout->nest('content','post.form',$this->data)->with('menus', $this->menus );	
	}
	...
	function getShow( $id = null)
	{
		...
		$this->data['id'] = $id;
		$this->data['access']		= $this->access;
		$this->layout->nest('content','post.view',$this->data)->with('menus', $this->menus );	
	}	
	...
	public function postDestroy()
	{
		...
		return Redirect::to('post?md='.Input::get('md'));
	}			
